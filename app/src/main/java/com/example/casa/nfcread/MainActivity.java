package com.example.casa.nfcread;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTagContent= (EditText) findViewById(R.id.textTagContent);
    }

    protected void onResume(){
        super.onResume();
        enableForegroundDispatchSystes();
    }

    protected void onPause(){
        super.onPause();
        disableForegroundDispatchSystes();
    }
    ...
    private void enableForegroundDispatchSystes(){
    ...
    private void disableForegroundDispatchSystes(){
